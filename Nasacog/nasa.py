...
class Nasa(commands.Cog):
    ...
    async def apod(self, ctx):
        ...
        url = "https://api.nasa.gov/planetary/apod?api_key=place-api-key-here"
    ...
    async def date(self, ctx, date: str):
        ...
        if date < "2015-06-13":
            ...
            return
        url = "https://api.nasa.gov/EPIC/api/natural/date/" + date + "?api_key=place-api-key-here"
        response = requests.get(url)
        data = response.json()
        ...
        if data == []:
            ...
            date = date.replace("-", "/")  
            url = "https://api.nasa.gov/EPIC/archive/natural/" + date + "/png/" + random_image + ".png" + "?api_key=place-api-key-here"
    ...
    async def curiosity(self, ctx):
        ...
        url = f"https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?sol={sol}&api_key=place-api-key-here"
        response = requests.get(url)
        data = response.json()
        photos = data["photos"]
    ...
    async def opportunity(self, ctx):
        ...
        ## randomize sol in api reuqest
        sol = random.randint(0, 1000)
        url = f"https://api.nasa.gov/mars-photos/api/v1/rovers/opportunity/photos?sol={sol}&api_key=place-api-key-here"
        response = requests.get(url)
        data = response.json()
        photos = data["photos"]
        photo = random.choice(photos)
    ...
    async def spirit(self, ctx):
        ...
        ## randomize sol in api reuqest
        sol = random.randint(0, 1000)
        url = f"https://api.nasa.gov/mars-photos/api/v1/rovers/spirit/photos?sol={sol}&api_key=place-api-key-here"
        response = requests.get(url)
        data = response.json()
        photos = data["photos"]
        photo = random.choice(photos)
